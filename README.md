...
int main(void)
{
  ...
  {
    	Lcd_cursor(&lcd,1,1);
    	  	  Lcd_string(&lcd,"Thivakar.R");
  }
}
```
## Output screen shots of proteus  :
 
 ![thiv4i](https://user-images.githubusercontent.com/118707074/236766032-4134a953-e903-4245-a0e6-0651ec4c926e.jpg)

 
## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

 ![thiv4ii](https://user-images.githubusercontent.com/118707074/236766046-4c92bdb2-c615-45b8-b24a-00804cf5e731.jpg)
